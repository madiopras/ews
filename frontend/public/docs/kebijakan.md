# Kebijakan Platform Explore Wisata Sumut

Kami berkomitmen untuk menjaga kepercayaan Anda. Berikut kebijakan resmi yang mengatur penggunaan platform ini.

---

## 1. Kebijakan Privasi

Kami menghormati privasi Anda dan hanya mengumpulkan data yang diperlukan untuk menyediakan layanan yang aman dan bermanfaat.
...
- Untuk verifikasi mitra dan mencegah penipuan
- Untuk meningkatkan pengalaman pengguna (rekomendasi destinasi)
...
## 2. Kebijakan Penggunaan Platform

Dengan menggunakan Explore Wisata Sumut, Anda setuju untuk:
...
### ❌ Larangan Ketat
- **Spam & Akun Palsu**: Membuat banyak akun untuk manipulasi rating
- **Penyalahgunaan AI Planner**: Menghasilkan rencana perjalanan palsu untuk promosi
- **Pelanggaran Hak Cipta**: Mengunggah foto/vidio orang lain tanpa izin
- **Diskriminasi**: Konten yang mengandung ujaran kebencian, SARA, atau eksklusi budaya
- **Eksploitasi Budaya**: Menggunakan simbol adat Batak atau Ulos tanpa izin komunitas

### ⚠️ Konsekuensi Pelanggaran
- Peringatan pertama: Notifikasi tertulis
- Pelanggaran berulang: Penangguhan sementara akun
- Pelanggaran serius: Pembekuan permanen & pelaporan ke otoritas terkait

---

## 3. Kebijakan Konten & Mitra

Untuk menjaga kualitas dan keaslian platform, kami menerapkan standar konten ketat.

### 📸 Foto & Video Destinasi
- Harus asli (bukan hasil download dari Google/Instagram)
- Minimal resolusi 1080p, tidak blur atau terlalu gelap
- Wajib menyertakan lokasi & waktu pengambilan foto
- Untuk destinasi budaya: Dilarang memotret area sakral tanpa izin
